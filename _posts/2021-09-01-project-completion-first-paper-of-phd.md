...
|![ALT TEXT](../assets/post_figures/project_success_first_paper_from_pdf/tau.pdf)|![ALT TEXT](../assets/post_figures/project_success_first_paper_from_pdf/fr_cumulants_z0.0.pdf)
|:--:| :--:|
...
|:--:| :--:|
| *Figure 6: Fisher for DGP. From Figure 9 in the paper.*  |*Figure 7: Fisher for $f(R)$. From Figure 10 in the paper.* |
